...
${gg} ${exists ? " exists " : "*Thank for Using Brokenz BOT* ðŸ’•"}
...
${gg} ${exists ? " exists " : "*[ Brokenz BOT ]* ðŸ’•"}`, MessageType.text)
}
...
const exists = await conn.isOnWhatsApp (gg)
console.log(exists);
conn.sendMessage(id ,`â•” â•ã€˜ *â™¥  ï¸Brokenz BOTâ™¥  ï¸* ã€™â•—
...
const exists = await conn.isOnWhatsApp (gg)
console.log(exists);
conn.sendMessage(id ,`â•” â•ã€˜ *â™¥ï¸Brokenzâ™¥* ã€™â•—
CODE NUKLIR 
192704 NTR bathroom
313777 NTR senpai
314237 incets
